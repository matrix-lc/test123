...
local rawAnimationData = {} do
	for i, animationDataCollectionModule in pairs(script:GetChildren()) do
...
local function regenerateClientAnimations()
	local animationController = humanoid
